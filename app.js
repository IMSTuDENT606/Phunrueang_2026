...
function findStaffAccount(username, password) { return STAFF_ACCOUNTS.find((account) => String(account.username) === String(username).trim() && (account.passwords || []).includes(String(password))); }
